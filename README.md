...
<a href="https://www.codecogs.com/eqnedit.php?latex=$$\DeclareMathOperator*{\argmin}{arg\,min}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}})&space;=&space;\min_{\theta}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}},&space;\theta)\,,\quad&space;\hbox{and}&space;\quad&space;m_i&space;=&space;\argmin_{\theta}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}},&space;\theta)$$" target="_blank"><img src="https://latex.codecogs.com/gif.latex?$$\DeclareMathOperator*{\argmin}{arg\,min}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}})&space;=&space;\min_{\theta}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}},&space;\theta)\,,\quad&space;\hbox{and}&space;\quad&space;m_i&space;=&space;\argmin_{\theta}\mathcal{C}(y_{(\tau_i&plus;1):\tau_{i&plus;1}},&space;\theta)$$" title="$$\DeclareMathOperator*{\argmin}{arg\,min}\mathcal{C}(y_{(\tau_i+1):\tau_{i+1}}) = \min_{\theta}\mathcal{C}(y_{(\tau_i+1):\tau_{i+1}}, \theta)\,,\quad \hbox{and} \quad m_i = \argmin_{\theta}\mathcal{C}(y_{(\tau_i+1):\tau_{i+1}}, \theta)$$" /></a>
