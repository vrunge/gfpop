...
```{r}
#If an error occurs delete 00LOCK-gfpop directory
#The full data is only available on github (the CRAN version has a truncated version for profile614chr2 data)
